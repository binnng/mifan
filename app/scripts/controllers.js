...
Mifan.controller("rootCtrl", function($scope, $cookieStore, $http) {
  var API, IsDebug, LOC, accessToken, getUserInfo, getUserInfoCb, getUserInfoErrorCb, setUserInfo, toggleMMenu, uid, username;
  LOC = $scope.LOC;
  API = $scope.API;
  IsDebug = $scope.IsDebug;
  $scope.page = "home";
  ...
  return $scope.href = function(url, isToggleMmenu) {
    LOC["href"] = url;
    if (isToggleMmenu) {
      return toggleMMenu();
    }
