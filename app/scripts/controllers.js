...
// Generated by CoffeeScript 1.7.1
"use strict";
Mifan.controller("rootCtrl", function($scope, $cookieStore, $http, $timeout) {
  var API, BODY, DOC, IsDebug, LOC, WIN, accessToken, elMMwrap, getUserInfo, getUserInfoCb, getUserInfoErrorCb, setUserInfo, toggleMBill, toggleMDesign, toggleMMenu, uid, username;
  WIN = $scope.WIN;
  DOC = $scope.DOC;
  LOC = $scope.LOC;
  BODY = $scope.BODY;
  ...
  $scope.scrollBody1Px = function() {
    if (elMMwrap["scrollTop"] === 0) {
      return elMMwrap["scrollTop"] = 1;
    }
  };
  return $scope.backToTop = function(isM) {
    return (isM ? elMMwrap : BODY)["scrollTop"] = 0;
  };
});
