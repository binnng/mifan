...
Mifan.directive "usermenu", ->
	...
	template = [
			...
			'<ul>'
		    '<li class="visible-xs"><a href="#!/"><span class="glyphicon glyphicon-bell"></span>提醒</a></li>'
		    '<li><a href="#!/"><span class="glyphicon glyphicon-cog"></span>设置</a></li>'
		    '<li class="visible-xs"><a href="#!/"><span class="glyphicon glyphicon-search"></span>找人</a></li>'
